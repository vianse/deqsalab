...
class ArchivosControllerTest < ActionController::TestCase
  ...
  test "should create archivo" do
    assert_difference('Archivo.count') do
      post :create, archivo: { archivo: @archivo.archivo, cliente: @archivo.cliente, fecha: @archivo.fecha, folio: @archivo.folio, referencia: @archivo.referencia }
    end
  ...
  test "should update archivo" do
    patch :update, id: @archivo, archivo: { archivo: @archivo.archivo, cliente: @archivo.cliente, fecha: @archivo.fecha, folio: @archivo.folio, referencia: @archivo.referencia }
    assert_redirected_to archivo_path(assigns(:archivo))
  end
